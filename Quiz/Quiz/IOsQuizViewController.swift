...
class IOsQuizViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBAction func nextPress(_ sender: Any) {
        ...
        if(selectedQuizList[quizNum].quizANS == selectedQuizList[self.quizNum].myANS){
            ansImage.image = #imageLiteral(resourceName: "correct")
        }else{
            ansImage.image = #imageLiteral(resourceName: "incorrect")
        }
